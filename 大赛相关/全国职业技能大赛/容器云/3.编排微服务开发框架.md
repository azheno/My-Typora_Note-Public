...
![图1.png](https://fdfs.douxuedu.com/group1/M00/00/44/wKggBmIe0VWAIzYwAADtytL0tcI320.png)
图1

使用默认的账号和密码，输入验证码，点击登录。如图所示：

![图2.png](https://fdfs.douxuedu.com/group1/M00/00/44/wKggBmIe0ViAWMc_AACqo5KHjWw552.png)
图2